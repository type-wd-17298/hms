...
?>
<form id="frmSearch" class="form-inline1 " data-pjax="true">
    <div class="input-group input-group-md  mr-2">
        ...
        <?PHP
        if (!isset($modeSearch) || $modeSearch == true)
            echo Html::button('<i class="fa-solid fa-folder-plus"></i> เพิ่มแผนปฏิบัติการ', ['class' => 'form-control btn btn-primary btnCreate font-weight-bold']);
        ?>
    </div>
</form>
