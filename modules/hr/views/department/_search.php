...
<div class="person-search">
    <form id="frmIndex" class="form-inline1" data-pjax="true">
        ...
        <div class="input-group input-group-md mr-2">
             ...
             */
            echo Html::dropDownList('dep', (isset($_GET['dep']) ? $_GET['dep'] : ''), ArrayHelper::map(app\modules\hr\models\EmployeeCategory::find()->orderBy(['sort' => 'ASC'])->asArray()->all(), 'category_id', 'category_name'),
                    [
            ...
            <div class="input-group-append">
                ...
                <?= Html::a('<i class="fa-regular fa-rectangle-list"></i> <b>เพิ่มหน่วยงาน</b>', 'javascript:;', ['class' => 'btn btn-dark btnPopup']) ?>
                {export}
            </div>
        </div>
    </form>
