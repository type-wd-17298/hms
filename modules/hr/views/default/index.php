        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    ...
                    //. '<br>' . $model['posit'];
                    //. '<br>' . @Html::tag('small', $model['dep']['department_name'], ['style' => ['font-size' => '10px']]);
...
//            }
            ...
            [
                ...
                'visible' => 1,
                'value' => function ($model) {
                    return $model->dep->department_name;
                }
            ],
            [
                'headerOptions' => ['class' => 'font-weight-bold'],
            ...
            /*
              ...
              <a class="dropdown-item btnFilters" href="javascript:void();">เพิ่มรายการ</a>
              <a class="dropdown-item btnFilters" href="javascript:void();">จัดการตำแหน่ง</a>
              <a class="dropdown-item btnFilters" href="javascript:void();">ย้ายแผนก</a>
