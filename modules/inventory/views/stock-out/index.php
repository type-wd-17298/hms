...
$this->title = 'เบิก/จ่ายวัสดุ';
$this->params['breadcrumbs'][] = $this->title;
?>
<h3 class="font-weight-bold"><i class="fa-solid fa-warehouse"></i></i> <?= $this->title ?></h3>
<?php Pjax::begin(); ?>
<?php
...
GridView::widget([
    ...
    'panel' => [
        'heading' => '',
        'type' => '',
        'before' => Html::a('<i class="fa-solid fa-circle-plus me-1"></i> เพิ่มใบเบิกพัสดุ', ['create'], ['class' => 'btn btn-outline-primary']) . ' ',
    ...
    'columns' => [
        ...
        [
            ...
            'noWrap' => TRUE,
            'width' => '3%',
            'attribute' => 'asset_stockout_date',
            'hAlign' => 'right',
            'format' => 'raw',
            'value' => function ($model) {
                return app\components\Ccomponent::getThaiDate($model->asset_stockout_date, 'S');
            }
        ],
        [
            'label' => 'เลขที่เอกสาร',
            ...
            'format' => 'raw',
            'value' => function ($model) {
                return Html::a("<b>{$model->asset_stockout_no}</b><br><span class='small'>ใบเบิกของจากคลัง</span>", ['update', 'id' => $model->asset_stockout_id], [
                    'class' => '',
                ]);
            }
        ],
        [
            'label' => 'หมายเหตุ',
            'attribute' => 'asset_stockout_comment',
            //'width' => '10%',
            'vAlign' => 'top',
        /*
          'value' => function ($model) {
        ...
        [
            ...
            'attribute' => 'asset_stockout_summary',
            'format' => ['decimal', 2],
            'noWrap' => TRUE,
            'hAlign' => 'right',
            'vAlign' => 'top',
        ...
        [
            ...
            'attribute' => 'employee_id',
            'value' => function ($model) {
                return Html::a('บันทึกรับสินค้า', ['update', 'id' => $model->asset_stockout_id], [
