...
class ViewController extends Controller {
    ...
    public function actionAcknowledge($id) {
        ...
        @Cmqtt::public('hms/service/operation/' . $emp->employee_id, date('Y-m-d H:i:s')); //Update MQTT เจ้าของเรื่อง
    ...
    public function actionListView() {
        ...
        $model->andWhere(['OR',
                ...
                ->addParams([':employeeID_to_find' => $emp->employee_id, ':employeeDEP_to_find' => (isset($params['dep']) && $params['dep'] <> '' ? $params['dep'] : $emp->employee_dep_id)]);
        if (isset($params['search']) && $params['search'] <> '') {
            $model->andWhere(['OR',
                ...
                ['like', 'paperless_view_id', @$params['search']],
            ]);
        //}else{
			//$model->andWhere("paperless_view_startdate >= '{$budgetYear_start}' ");  ///
		}

        if (!empty($params['dep']) && $params['dep'] <> '')
