...
<div class="card">
    <div class="default-tab">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="tabLink nav-link font-weight-bold" data-bs-toggle="tab"  href="#paper-history" data-href="<?= Url::to(['index', 'view' => 'history']) ?>"><i class="fa-solid fa-clock me-2"></i> ประวัติการลา</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="tabLink nav-link font-weight-bold" data-bs-toggle="tab"   id="tabSelected"  href="#paper-list" data-href="<?= Url::to(['index', 'view' => 'list']) ?>"><i class="fa-solid fa-folder-tree me-2"></i> ทะเบียนการลา</a>
            </li>
