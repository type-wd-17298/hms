        ...
        <tr>
            <td width="50%"  style="vertical-align: top">
                ...
                <table border="1" width="100%" style="font-size: 16pt; border: 1px; border-collapse: collapse;">
                    ...
                    <tr>
                        <th>พักผ่อน</th>
                        <th style="text-align: center;"><?= @$model->accruedSS ?></th>
                        <th style="text-align: center;"><?= @$model->leave_day ?></th>
                        <th style="text-align: center;"><?= @$model->accruedSS + @$model->leave_day ?></th>
                    </tr>
                </table>
