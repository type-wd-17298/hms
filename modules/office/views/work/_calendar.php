                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div id="external-events" class="my-3">
                                <div class="external-event btn-success light" data-class="bg-success"><i class="fa fa-move"></i><span>ลาพักผ่อน</span></div>
                                <div class="external-event btn-warning light" data-class="bg-warning"><i class="fa fa-move"></i>ลากิจส่วนตัว</div>
                                <div class="external-event btn-danger light" data-class="bg-danger"><i class="fa fa-move"></i>ลาป่วย</div>
                                <div class="external-event btn-info light" data-class="bg-info"><i class="fa fa-move"></i>ลาคลอดบุตร</div>
