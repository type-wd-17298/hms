...
$src = Url::to(['view', 'id' => @$model->paperless_view_id]);
...
<div class="row">
    <div class="col-md-8">
        <?PHP #$form->field($model, 'paperless_uuid')->hiddenInput()->label(false) ?>
        <?=
        ...
        <?= $form->field($model, 'paperless_detail')->textarea(['rows' => 3, 'class' => 'form-control form-control-lg']) ?>
        <?php
