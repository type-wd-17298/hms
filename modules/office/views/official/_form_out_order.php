...
<div class="row">
    <div class="col-md-7">
        <div class="row">
            <div class="col-md-12">
                <?=
                $form->field($model, 'paperless_official_date')->label('วันที่หนังสือ')->widget(DatePicker::classname(), [
            ...
            <div class="col-md-12">
                <?=
                $form->field($model, 'paperless_official_order')->label('สั่ง ณ วันที่')->widget(DatePicker::classname(), [
                    'options' => ['placeholder' => 'สั่ง ณ วันที่', 'class' => 'form-control form-control-lg'],
                    'language' => 'th-TH',
                    'pluginOptions' => [
                        'autoclose' => true,
                        'format' => 'yyyy-mm-dd',
