...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                return empty($model->paperless_official_number) ? Html::button($model->paperless_official_type == 'BSN' ? 'ออกเลขหนังสือ' : 'ออกเลขประกาศ', [
                    'data-id' => $model->paperless_id,
                    'data-project' => $model->paperless_id,
                    'data-gen' => 'ออกเลขหนังสือประกาศ',
                    'data-number' => 0,
                    'class' => 'btnGenNum btn btn-xs btn-secondary active'
                ]) : substr($model->paperless_official_number, 8);
            }
        ],
        [
            'headerOptions' => ['class' => 'font-weight-bold'],
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title font-weight-bold">ออกเลขหนังสือราชการ (แฟ้มประกาศ)</h3>
