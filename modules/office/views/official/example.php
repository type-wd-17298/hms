...
$fontSize = 16;
$txtJustify = $model->paperless_official_detail; //@Ccomponent::strip_tags_content($model->paperless_official_detail);
...
<table border="0" width="100%" style="text-align:left;font-size: <?= $fontSize ?>pt;" cellspacing="0" cellpadding="0">
    <tr>
        <td width="48%"><b style="text-align:left;font-size: <?= $fontSize + 4 ?>pt;">ที่</b><span class="dotted">&nbsp;&nbsp;<?= Yii::$app->params['dep_bookNumberPrefix'] . @substr($model->paperless_official_number, 8) ?>&nbsp;&nbsp;&nbsp;&nbsp;</span>
        </td>
...
<div style="text-align:left;font-size: <?= $fontSize ?>pt;"><b style="text-align:left;font-size: <?= $fontSize + 4 ?>pt;">เรียน</b>&nbsp;ผู้อำนวยการ<?= Yii::$app->params['dep_name'] ?></div>
