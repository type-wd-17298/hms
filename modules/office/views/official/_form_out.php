...
<div class="row">
    <div class="col-md-7">
        <div class="row">
            <div class="col-md-12">
                <?=
                $form->field($model, 'paperless_official_date')->label('วันที่ส่งหนังสือ')->widget(DatePicker::classname(), [
                    'options' => ['placeholder' => 'วันที่ส่งหนังสือ', 'class' => 'form-control form-control-lg'],
                    'language' => 'th-TH',
                    'pluginOptions' => [
                        'autoclose' => true,
                        'format' => 'yyyy-mm-dd',
            ...
            <!--
                        <div class="col-md-6">
            <?PHP
            $form->field($model, 'paperless_official_type')->dropDownList(
                    ['BSN' => 'หนังสือทั่วไป', 'BCN' => 'หนังสือเวียน', 'BDN' => 'หนังสือคำสั่ง']
                    , ['class' => 'form-control form-control-lg', 'placeholder' => '--เลือกประเภทหนังสือ--'])
            ?>            </div>-->

            <div class="col-md-12">
                <?PHP //echo $form->field($model, 'paperless_official_from')->label('ส่งถึงหน่วยงาน')->textInput(['maxlength' => true, 'class' => 'form-control form-control-lg']) ?>
                <?PHP
                echo $form->field($model, 'paperless_official_from')->label('ส่งถึงหน่วยงาน')->widget(keygenqt\autocompleteAjax\AutocompleteAjax::class, [
                    'url' => ['auto-search'],
