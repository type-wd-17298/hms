...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <?=
                $form->field($model, 'staff_worklist_date')->widget(DatePicker::classname(), [
            ...
            <div class="col-md-4">
                <?=
                $form->field($model, 'worklist_group_id')->dropDownList(ArrayHelper::map(app\modules\servicedesk\models\StaffWorklistGroup::find()
                                        ->orderBy(['worklist_group_id' => SORT_ASC])
                                        ->all(), 'worklist_group_id', 'worklist_group_name')
                        , ['class' => 'form-control'])
                ?>
            </div>
            ...
            <div class="col-md-4">
                <?=
                $form->field($model, 'staff_worklist_date_finish')->widget(DatePicker::classname(), [
            ...
            <div class="col-md-12">
                <?PHP echo $form->field($model, 'staff_worklist_issue')->textInput(['maxlength' => true, 'class' => 'form-control form-control-lg']) ?>
            </div>

            <div class="col-md-12">
                <?= $form->field($model, 'staff_worklist_comment')->textarea(['rows' => 4, 'class' => 'form-control form-control-lg']) ?>
            </div>

            <div class="col-md-12">
                <?PHP
                echo $form->field($model, 'employee_id')->label('ผู้ดำเนินงาน')->widget(Select2::classname(), [
            ...
            <div class="col-md-12">
                <?PHP
                echo $form->field($model, 'department_id')->label('หน่วยงานที่เกี่ยวข้อง')->widget(Select2::classname(), [
                    'options' => ['placeholder' => '--เลือกหน่วยงานภายใน--'],
